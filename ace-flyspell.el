...
;; * Acknowledgment This package is based on
;;   [[https://github.com/winterTTr/ace-jump-mode][winterTTr]]'s awesome
;;   [[https://github.com/winterTTr/ace-jump-mode][ace-jump-mode]] package and
;;   inspired by [[https://github.com/abo-abo/ace-link][abo-abo(Oleh Krehel)]]'s
;;   [[https://github.com/abo-abo/ace-link][ace-link]] package, from which I
;;   borrowed two convenient macros, and this package is kind of like the a
;;   variant of the original [[https://github.com/abo-abo/ace-link][ace-link]]
;;   package although I made some further extensions to meet my own needs.
